    ...
    <div class="form-wrapper">
      <form class="joint-form" @submit.prevent="handleSubmit">
        ...
        <div class="form-section">
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              rows="5"
              placeholder="详细描述这次联合活动的内容、主题、目标..."
              required
            />
          </div>
        ...
        <div class="form-section">
          ...
          <div class="form-group">
            ...
            <input
              ...
              type="text"
              placeholder="QQ群号、微信群、Discord 等"
            />
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              rows="3"
              placeholder="参与门槛、需要具备的技能、注意事项等"
            />
          </div>
        </div>
        ...
        <div class="form-actions">
          <button type="button" class="btn-line" @click="goBack">取消</button>
          <button
            type="submit"
            class="btn-line btn-submit"
