<!-- src/views/世界观管理/type-editors/FactionEditor.vue -->
<template>
    ...
    <div class="editor-grid">
      <div class="left-column">
        <div class="field-group">
          <label>核心理念</label>
          <input v-model="localData.ideology" placeholder="如：维护和平、征服世界" />
        </div>

        <div class="field-group">
          <label>总部</label>
          <input v-model="localData.headquarters" placeholder="派系总部所在地" />
        </div>
...
import type { FactionData } from '../card_type'

const props = defineProps<{
  modelValue?: FactionData
}>()
...
const localData = ref<FactionData>({
  ...defaultData,
  ...(props.modelValue || {}),
})
